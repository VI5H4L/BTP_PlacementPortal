...
export default function Search(props){
    ...
    return (
        <div ref={search} onClick={click2} className={props.isSearchActive ? (SearchCSS.main_div + " " + SearchCSS.active) : (SearchCSS.main_div + " " + SearchCSS.notactive) }>
            ...
            <div className={isSearchActive? (SearchCSS.under_div + " " + SearchCSS.active) : (SearchCSS.under_div + " " + SearchCSS.notactive)}>
